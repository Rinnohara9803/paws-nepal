...
const AddSchedule = () => {
  ...
  return (
    <div className="flex flex-col items-start mx-auto mt-20 lg:w-1/4 sm:w-4/6">
      <h2 className="text-2xl font-bold mb-4">Add Appointment</h2>
      <div className="mb-4  flex flex-col w-full items-start">
        <label className="block text-gray-700 text-sm font-bold mb-2">
          Date
        </label>
        <DatePicker
          className="py-1 border-2 border-solid border-red-600 text-center bg-zinc-700 text-white"
          selected={startDate}
          onChange={(date) => {
            setStartDate(date);
            setAppointments([]);
      ...
      <div className="mb-4 flex flex-col w-full items-start">
        ...
        <input
          ...
          className="border rounded px-3 py-2 w-full bg-zinc-700"
        />
      </div>
      <div className="mb-4 flex flex-col w-full items-start">
        <label className="block text-gray-700 text-sm font-bold mb-2">
